...
const InsightCard = ({
  ...
  <button
    type="button"
    onClick={onToggle}
    className="glass hover-lift cursor-pointer p-5 transition-all duration-300 text-right w-full"
  >
    <div className="flex items-start justify-between gap-3">
      <div className="flex items-start gap-4 flex-1">
        ...
        <div>
          <h4 className="text-color-text-primary font-semibold mb-2">
            {insight.title}
          </h4>
          ...
          <div className="lg:col-span-10 space-y-12">
            ...
            <div className="mb-8 scroll-reveal">
              ...
              <p className="text-color-text-secondary max-w-2xl leading-relaxed">
                بررسی روند رشد ذهنی، بهره‌وری و تکامل شخصی شما.
              </p>
            </div>
            ...
            <div className="space-y-12">
              ...
              {growthData.length ? (
                  ...
                  <div className="glass p-8">
                    <div className="mb-8">
                      ...
                      <p className="text-color-text-secondary text-sm">
                        معیارهای توسعه شخصی در دوازده ماه
                      </p>
                    </div>
                ...
                <p className="glass p-8 text-center text-color-text-secondary">
                  هنوز داده‌ای برای تحلیل رشد ثبت نشده است.
                </p>
              ) : null}
