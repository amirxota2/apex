...
const Goals = () => {
  ...
  const normalizeGoal = (goal) => {
    ...
    const priorityValue =
      meta.priority || goal.category || "متوسط";
  ...
  const stats = useMemo(() => {
    ...
    const completed = goals.filter(
      (goal) =>
        goal.progress >= 100 || goal.is_completed
    ).length;
  ...
  const handleAddGoal = async (event) => {
    ...
    try {
      ...
      const enriched = {
        ...
        description:
          description.trim() || "بدون توضیح",
        priority,
        progress: 0,
        dueDate: dueDate
          ? dueDate.toISOString().split("T")[0]
          : created?.deadline || "بدون تاریخ",
      };
          ...
          >
            ...
            <button
              ...
              className="
                ...
                py-3
                rounded-2xl
                shadow-[0_15px_30px_rgba(0,242,234,0.3)]
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  هدف جدید را اضافه کنید تا در برنامه نمایش داده شود
                </p>
