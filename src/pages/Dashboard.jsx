...
const Dashboard = ({
  ...
  return (
    <div
      className="min-h-screen bg-[#080c14] text-white font-vazir p-4 md:p-6"
      dir="rtl"
    >
        ...
        <div className="lg:col-span-10 space-y-6 min-w-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <StatCard
              icon="🏆"
              label="امتیاز کل"
              value={(summary?.totalScore ?? 0).toLocaleString("fa-IR")}
              color="yellow"
            />
            ...
            >
              ...
              <div className="space-y-6">
                {weeklyProgress.length ? (
                  ...
                  <p className="text-sm text-gray-500">
                    هنوز داده‌ای برای این هفته ثبت نشده است.
                  </p>
                )}
              </div>
              ...
              >
                ...
                <p className="text-2xl font-black text-[#00f2ea]">
                  {summary?.progress ?? progressPercent}%
                </p>
